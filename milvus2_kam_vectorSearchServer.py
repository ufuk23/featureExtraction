...
def predict():
    try:
        ...
        resp_milvus = art.search(vectors, "embeddings", search_params, limit=100, expr=req_expr, output_fields=["artifact_type"])
        ...
        for hits in resp_milvus:
            for h in hits:
                ...
                # print(f"hit: {h}, artifact_type field: {h.entity.get('artifact_type')}")
